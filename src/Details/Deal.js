                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3">
                      ...
                      <p/>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                       ...
                       JOMO ethical copper mug, succulents typewriter shaman DIY kitsch twee taiyaki
                ...
                <div className="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-3">
                      ...
                      <p/>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                       do eiusmod tempor pack incididunt ut labore et dolore magna aliqua quised
                        ipsum suspendisse. <br/><br/>Swag fanny pack lyft blog twee. JOMO ethical
                         copper mug, succulents typewriter shaman DIY kitsch twee taiyaki fixie hella
                ...
                <div className="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                  <div className="row">
                    ...
                    <div className="col-lg-3">
                      ...
                      <p/>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                       do eiusmod tempor pack incididunt ut Kinfolk tonx seitan crucifix
                        3 wolf moon bicycle rights keffiyeh snackwave wolf same vice, 
                        chillwave vexillologistlabore et dolore magna aliqua quised ipsum suspendisse.
